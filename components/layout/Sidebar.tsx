...
export const Sidebar: React.FC = () => {
  const { activeTab, setActiveTab, isSidebarCollapsed, setSidebarCollapsed } = useTelemetryStore();
  ...
  return (
    <>
      {!isSidebarCollapsed ? (
        <aside className="w-72 bg-surface-light dark:bg-surface-dark border-r border-border-light dark:border-grid-line flex flex-col justify-between z-20 shadow-[4px_0_24px_rgba(0,0,0,0.1)] dark:shadow-[4px_0_24px_rgba(0,0,0,0.5)] transition-all duration-300 fixed h-full">
          <div>
            {/* Logo Area */}
          ...
          <div className="p-4 border-t border-border-light dark:border-grid-line bg-gray-100 dark:bg-bg-dark transition-colors duration-300 flex justify-between items-center">
            ...
            <button
              ...
              className="p-1 text-gray-500 dark:text-gray-400 hover:text-primary dark:hover:text-primary transition-colors"
